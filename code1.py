...
x['Qualification of teacher']=df['Qualification of teacher']
...
cols_to_keep = ['Student_1_5_Grade_performance', 'Schools_with_high_no_of_low_income_families', 'Probabaility that 2 student belong to different Race','Class Size Index','Qualification of teacher','No of Expulsion per 100 student','Long Suspensions per 100 students']
